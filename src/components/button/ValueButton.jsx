...
const ValueButton = ({ content, path }) => {
  ...
  return (
    <div className='laundary__custom_value_btn bg-[var(--color-bg)] rounded-lg border-solid border border-black shadow-lg hover:animate-pulse hover:bg-gray-600 dark:bg-[--color-darkbg2] dark:border-white '>
      <button 
        type='button' 
